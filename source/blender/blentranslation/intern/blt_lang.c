...
void BLT_lang_init(void)
{
	...
	printf("////////// BETTER BLENDER BEGIN: INSERT KEYFRAMES RECURSIVE //////////\n");
	printf("////////// BETTER BLENDER BEGIN: OBNOXIOUS RECORD //////////\n");
	printf("////////// BETTER BLENDER BEGIN: SET START FRAME FOR BACKGROUND VIDEO //////////\n");
